...
public class PruebaService {
    ...
    // Create
    public ResponseEntity<String> crearPrueba(List<String> codigos, List<String> respuestas, String dificultad, List<String> preguntas){
        try {
            PruebaEntity nuevaPrueba = new PruebaEntity();

            int idCodigo1 = crearCodigo(codigos.get(0), respuestas.get(0), preguntas.get(0));
            int idCodigo2 = crearCodigo(codigos.get(1), respuestas.get(1), preguntas.get(1));
            int idCodigo3 = crearCodigo(codigos.get(2), respuestas.get(2), preguntas.get(2));
            int idCodigo4 = crearCodigo(codigos.get(3), respuestas.get(3), preguntas.get(3));
